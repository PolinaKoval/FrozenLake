...
class QLearningAgent(object):
    def __init__(self, action_space, observation_space, DF, LF, lam, er, er_limit):
        ...
        self.qmatrix = [[0.4 for _ in range(action_space.n)] for _ in range(observation_space.n)]
...
if __name__ == '__main__':
    for i in xrange(0, 10):
        print "game {}".format(i),
        agent = QLearningAgent(env.action_space, env.observation_space, 0.99, 0.1, 0.2, 0.1, 100)
        run(agent)
